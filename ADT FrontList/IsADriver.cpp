...
#include <iostream>
#include <string>
#include "IsAFrontList.h" // ADT sorted list operations

using namespace std;

void displayList(IsAFrontList <string>* listPtr)
{
...
void copyConstructorTester()
{
   ...
   IsAFrontList<string> copyOfList(list);
   cout << "Copy of list: ";
...
void sortedListTester(IsAFrontList <string>* listPtr)
{
   string luke = "Luke";
   string brent = "Brent";
   string donna = "Donna";
...
void listOpsTester(IsAFrontList <string>* listPtr)
{
   string luke = "Luke";
   string brent = "Brent";
   string donna = "Donna";
...
int main()
{
   copyConstructorTester();
	...
	IsAFrontList <string>* listPtr = new IsAFrontList<string>();
