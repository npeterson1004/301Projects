...
#include <iostream>
#include <string>
#include "HasAFrontList.h" // ADT sorted list operations
...
void copyConstructorTester()
{
   ...
   HasAFrontList<string> copyOfList(list);
   cout << "Copy of list: ";
...
void sortedListTester(FrontListInterface<string>* listPtr)
{
   string luke = "Luke";
   string brent = "Brent";
   string donna = "Donna";
...
int main()
{
   copyConstructorTester();
	...
	FrontListInterface<string>* listPtr = new HasAFrontList<string>();
