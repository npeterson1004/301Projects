...
/** @file HasAFrontList.h
 * @brief Header file for the HasAFrontList class, a sorted linked list implementation.
 * It composes a ListInterface pointer and implements the FrontListInterface.
...
/**
 * @brief HasAFrontList class, a sorted linked list implementation.
 * @tparam ItemType The type of the items stored in the list.
 */
template<class ItemType>
class HasAFrontList : public FrontListInterface<ItemType>
{
private:
...
public:
    ...
    */
   HasAFrontList(const HasAFrontList<ItemType>& sList);

   /**
    * @brief Destructor.
    */
   virtual ~HasAFrontList();
