...
#include <iostream>
#include <string>
#include "AsAFrontList.h" // ADT sorted list operations
...
void copyConstructorTester()
{
   ...
   AsAFrontList<string> copyOfList(list);
   cout << "Copy of list: ";
...
int main()
{
   copyConstructorTester();
	...
	FrontListInterface<string>* listPtr = new AsAFrontList<string>();
